...
# CNN1
echo "Training model CNN1, lr = 1e-3, epochs = 20, batch_size = 256"
python train.py \
        --lr 1e-3 \
        --epochs 20 \
        --batch_size 256 \
...
echo "Training model CNN1, lr = 1e-4, epochs = 20, batch_size = 256"
python train.py \
        --lr 1e-4 \
        --epochs 20 \
        --batch_size 256 \
...
echo "Training model CNN1, lr = 1e-5, epochs = 20, batch_size = 256"
python train.py \
        --lr 1e-5 \
        --epochs 20 \
        --batch_size 256 \
